      ...
      <Show when={stepId() === 'welcome'}>
        <div class="rounded-xl border border-[color:var(--color-line)] bg-[color:var(--color-surface)] p-8 shadow-[var(--shadow-sm)]">
          ...
          <p class="mt-3 text-sm text-[color:var(--color-muted)] leading-relaxed">
            Brief learns how you write quotes by reading one you've already sent. That takes about a minute and is how everything downstream — drafts, follow-ups, the way Brief talks back to you — stays in your voice.
          </p>
          <p class="mt-3 text-sm text-[color:var(--color-muted)] leading-relaxed">
            Six more steps. None of them are graded.
          </p>
          <div class="mt-6 flex justify-end">
            <Button variant="accent" onClick={next}>Begin →</Button>
          </div>
        </div>
      </Show>
      ...
      <Show when={stepId() === 'upload'}>
        <div class="rounded-xl border border-[color:var(--color-line)] bg-[color:var(--color-surface)] p-8 shadow-[var(--shadow-sm)]">
          ...
          <h2 class="mt-1 font-serif text-[24px] font-medium leading-tight">
            Paste a quote, email, or proposal you've sent recently.
          </h2>
          <p class="mt-3 text-sm text-[color:var(--color-muted)] leading-relaxed">
            Brief reads it and learns your vocabulary, tone, and boilerplate. Anything from the last 6 months works best — the more text, the sharper the match.
          </p>
          <div class="mt-5">
